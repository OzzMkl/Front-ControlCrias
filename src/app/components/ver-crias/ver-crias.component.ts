...
@Component({
  selector: 'app-ver-crias',
  templateUrl: './ver-crias.component.html',
  styleUrls: ['./ver-crias.component.css']
})
export class VerCriasComponent implements OnInit {
...
getCriasSanas(){
  this._criaService.getCriasSanas().subscribe(
    response =>{
